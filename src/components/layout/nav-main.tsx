            ...
            return (
              <SidebarMenuItem key={item.title}>
                <SidebarMenuButton
                  tooltip={item.title}
                  asChild
                  className={`${isActive ? "bg-jagged-ice-100 font-medium dark:text-primary-foreground dark:hover:text-primary-foreground hover:bg-jagged-ice-100" : ""} hover:font-medium`}
                >
                  <a href={item.url}>
                    {item.icon && <item.icon />}
